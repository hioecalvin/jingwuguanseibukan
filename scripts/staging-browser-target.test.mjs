...
test("request guard allows reads and ephemeral auth but rejects writes and unknown origins", () => {
  const cases = [
    ...
    ["POST", `${STAGING_SUPABASE_ORIGIN}/rest/v1/rpc/get_regular_class_schedules`, true],
    ...
    ["POST", `${STAGING_SUPABASE_ORIGIN}/rest/v1/rpc/get_super_admin_settlements`, true],
    ["POST", `${STAGING_SUPABASE_ORIGIN}/rest/v1/rpc/get_settlement_eligible_payment_details`, true],
    ["POST", `${STAGING_SUPABASE_ORIGIN}/rest/v1/rpc/get_dojo_settlement_item_details`, true],
    ["POST", `${STAGING_SUPABASE_ORIGIN}/rest/v1/rpc/get_my_repository_upload_scopes`, true],
    ["POST", `${STAGING_SUPABASE_ORIGIN}/rest/v1/rpc/get_repository_uploader_candidates`, true],
    ["POST", `${STAGING_SUPABASE_ORIGIN}/rest/v1/rpc/get_repository_uploader_options`, true],
    ...
    ["POST", `${STAGING_SUPABASE_ORIGIN}/rest/v1/rpc/upsert_regular_class_schedule`, false],
    ["POST", `${STAGING_SUPABASE_ORIGIN}/rest/v1/rpc/update_my_contact_details`, false],
    ["POST", `${STAGING_SUPABASE_ORIGIN}/rest/v1/rpc/assign_repository_uploader`, false],
    ["POST", `${STAGING_SUPABASE_ORIGIN}/rest/v1/rpc/revoke_repository_uploader`, false],
    ["POST", `${STAGING_SUPABASE_ORIGIN}/rest/v1/rpc/create_repository_content`, false],
    ["POST", `${STAGING_SUPABASE_ORIGIN}/rest/v1/rpc/update_repository_content`, false],
    ["POST", `${STAGING_SUPABASE_ORIGIN}/rest/v1/rpc/delete_repository_content`, false],
